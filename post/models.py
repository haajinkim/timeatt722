...
class JobPostActivity(models.Model):
    ...
    job_post_status = models.ForeignKey("Jobstatus",on_delete=models.CASCADE,null=True)
    job_profress =models.ForeignKey("JobPostProgress", on_delete=models.CASCADE, null=True)
...
class JobPostProgress(models.Model):

    job_profress = models.CharField(max_length=150)
